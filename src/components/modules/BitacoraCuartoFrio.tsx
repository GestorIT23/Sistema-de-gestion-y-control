...
import { Calendar, User, ArrowLeft, Download, Database, Snowflake, AlertTriangle, CheckSquare, FileText, FileSpreadsheet , Trash2} from 'lucide-react';
    ...
    <div id="bitacora-frio-root" className="max-w-6xl mx-auto px-4 py-6 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <BulkUploadPanel tipo="cuarto_frio" userEmail={userEmail} onSuccess={fetchRegistros} />
